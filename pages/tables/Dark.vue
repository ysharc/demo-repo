                    ...
                    <v-table theme="dark" class="month-table">
                        ...
                        <tbody>
                            <tr v-for="item in darkTableData" :key="item.name" class="month-item">
                                ...
                                <td>
                                    <h6 class="text-h6 text-no-wrap font-weight-medium text-medium-emphasis">{{ item.pname }}</h6>
                                </td>
                                <td>
                                    <div class="d-flex align-center">
                                ...
                                <td>
                                    <v-chip rounded="md" class="font-weight-medium" :color="item.statuscolor" size="small"
                                        label>{{
                                            item.status
                                        }}</v-chip>
                                </td>
