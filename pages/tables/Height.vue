                            ...
                            <tr v-for="item in heightTableData" :key="item.name" class="month-item">
                                <td>
                                    <div class="d-flex align-center">
                                        ...
                                        <div class="ml-4">
                                            <h6 class="text-subtitle-1 text-no-wrap font-weight-medium">{{ item.name }}</h6>
                                            <div class="text-subtitle-1 text-no-wrap font-weight-medium text-medium-emphasis mt-1">{{ item.handle }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <div class="text-subtitle-1 text-no-wrap font-weight-medium text-medium-emphasis">{{ item.users }}</div>
                                </td>
                                <td>
