  ...
  <v-menu :close-on-content-click="false">
    <template v-slot:activator="{ props }">
      <v-btn class="custom-hover-primary" variant="text" v-bind="props" icon>
        <v-avatar size="35">
          <img src="/images-ms/dashboard/recentInflu-3.png" width="35" alt="Julia" />
        </v-avatar>
      </v-btn>
    </template>
    <v-sheet rounded="md" width="360" elevation="10">
      <div class="px-8 pt-6">
        ...
        <div class="d-flex align-center mt-4 pb-6">
          <v-avatar size="80">
            <img src="/images-ms/dashboard/recentInflu-3.png" width="80" />
          </v-avatar>
          <div class="ml-3">
            <h6 class="text-h6 mb-n1">Julia Alex</h6>
