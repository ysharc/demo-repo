    ...
    <v-navigation-drawer app temporary elevation="10" location="right" v-model="customizer.Customizer_drawer" width="320">
        ...
        <perfect-scrollbar style="height: calc(100vh - 90px)">
            <div class="pa-6">
                ...
                <v-btn-toggle v-model="customizer.setHorizontalLayout" color="primary" class="my-2 btn-group-custom"
                    rounded="0" group>
                ...
                <v-sheet v-if="customizer.setHorizontalLayout != true">
                    ...
                    <v-btn-toggle v-model="customizer.mini_sidebar" color="primary" class="my-2 btn-group-custom"
                        rounded="0" group>
                        <v-btn :value="false" variant="text" elevation="9" class="rounded-md">
                ...
                <v-btn-toggle v-model="customizer.setBorderCard" color="primary" class="my-2 btn-group-custom" rounded="0"
                    group>
                    <v-btn :value="false" variant="text" elevation="9" class="rounded-md">
                        <LayoutSidebarLeftCollapseIcon stroke-width="1.5" size="21" class="mr-2" />
                        Shadow
