    ...
    <v-card>
        <v-card-item class="py-8 text-center">
            ...
            <div class="d-sm-flex align-center justify-center gap-3 mt-5 mb-5">
                <v-btn color="primary" variant="tonal" to="/apps/ecommerce/products">Continue to Shopping</v-btn>
                <v-btn color="primary" class="mt-4 mt-sm-0" flat>Download Invoice</v-btn>
            </div>
        </v-card-item>
    </v-card>
</template>
