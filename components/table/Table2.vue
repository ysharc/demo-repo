        ...
        <v-table class="month-table">
            ...
            <tbody>
                <tr v-for="item in basicTableData2" :key="item.name" class="month-item">
                    ...
                    <td>
                        <div class="text-subtitle-1 text-no-wrap font-weight-medium ">{{ item.post }}</div>
                    </td>
                    <td>
                        <div class="d-flex align-center">
                    ...
                    <td>
                        <v-chip rounded="lg" class="font-weight-medium py-4 px-3" :color="item.statuscolor" size="small">
                            {{ item.status }}
                        </v-chip>
                    </td>
                    <td>
