        ...
        <v-table class="month-table">
            ...
            <tbody>
                <tr v-for="item in basicTableData1" :key="item.name" class="month-item">
                    ...
                    <td>
                        <h6 class="text-subtitle-1 font-weight-medium  text-no-wrap" >{{ item.pname }}</h6>
                    </td>
                    <td>
                        <div class="d-flex align-center">
                    ...
                    <td>
                        <v-chip rounded="md" class="font-weight-medium" :color="item.statuscolor" size="small" label>{{
                            item.status
                        }}</v-chip>
                    </td>
                    <td>
