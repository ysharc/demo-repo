                    ...
                    <td>
                        <div class="d-flex align-center">
                            ...
                            <div class="ml-4">
                                ...
                                <div class="text-subtitle-1 text-no-wrap font-weight-medium text-medium-emphasis">{{ item.handle }}</div>
                            </div>
                        </div>
                    </td>
                    <td>

                        <v-chip rounded="lg"  v-if="item.statusoffline" class="font-weight-medium pl-1 pr-2" :color="item.statuscolor" size="small">
                            <ClockHour4Icon size="15" class="mr-1" />
                            {{ item.status }}
                        </v-chip>

                        <v-chip rounded="lg" v-else class="font-weight-medium pl-1 pr-2" :color="item.statuscolor" size="small">
                        ...
                        <div class="d-flex align-center">
                            <div class="d-flex">
                                <v-chip
                                    ...
                                    :key="team.status"
                                    rounded="lg"
                                    :class="'font-weight-medium px-2 mr-2 bg-' + team.statuscolor"
                                    size="small"
                                >
                                    {{ team.status }}
                                </v-chip>
